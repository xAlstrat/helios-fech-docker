...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': get_from_env('DATABASE_USER', None),
        'PASSWORD': get_from_env('DATABASE_PASSWORD', None),
        'HOST': get_from_env('DATABASE_HOST', None),
        'PORT': get_from_env('DATABASE_PORT', None)
    }
}
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "ELECCIONES FECH 2020")
...
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL', 'no-reply@em3800.eleccionesfech.cl')
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Elecciones FECh')
...
# set up celery
CELERY_BROKER_URL = get_from_env('CELERY_BROKER_URL', 'amqp://rabbitmq')
if TESTING:
